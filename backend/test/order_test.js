...
const { updateOrder,getAllOrders, getOrderForUser, addOrder,deleteOrder } = require('../controllers/orderController');
const { expect } = chai;
...
describe('GetOrderForUser Function Test', () => {
  it('should return users orders', async () => {
    // Mock user ID
    const userId = new mongoose.Types.ObjectId();
...
describe('GetAllOrders Function Test', () => {
  ...
  it('should return all orders', async () => {
    ...
    // Mock request & response
    const req = {user: { id: userId, role: 1 }, query: {}};
    const res = {
      json: sinon.spy(),
      status: sinon.stub().returnsThis()
    };
